...
step_desktop() {
    ...
    if [ "$DE_CHOICE" == "1" ]; then
        ...
        install_pkg "konsole" "XFCE4 Terminal"
...
pgrep -x "plasmashell" > /dev/null 2>&1 && xfce4-panel --restart > /dev/null 2>&1 &
...
XWEOF
    ...
    cat > ~/.config/xfce4/xfconf/xfce-perchannel-xml/konsole.xml << 'TERMEOF'
<?xml version="1.0" encoding="UTF-8"?>
<channel name="konsole" version="1.0">
...
<channel name="xfce4-keyboard-shortcuts" version="1.0">
  <property name="commands" type="empty">
    <property name="custom" type="empty">
      ...
      <property name="&lt;Super&gt;t" type="string" value="konsole"/>
...
COMPLETE
    ...
    echo "    - Modern KDE Plasma Desktop (Adwaita + Dracula terminal)"
    echo ""
    echo -e "${YELLOW}============================================================${NC}"
    ...
    echo ""
    echo -e "  ${GREEN}Install proot app → sync to KDE application launcher:${NC}"
